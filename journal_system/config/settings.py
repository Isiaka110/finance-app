...
# Checks if the .env file says "True"
DEBUG = os.getenv('DEBUG') == 'True'

# Allow localhost and any other host (useful for testing deployment)
...
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage' # Optimizes files for production
...
# For production (Example configuration commented out):

...
export default function IncomePage() {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            const payload = { ...form, type: 'income', amount: parseFloat(rawAmt) };
                        ...
                        <form onSubmit={handleSave}>
                            <div className="form-row">
                                <div className="form-group">
                                    ...
                                    <input className="form-input" type="text" placeholder="e.g. 30,000" value={form.amount} onChange={e => setForm(f => ({ ...f, amount: e.target.value.replace(/[^0-9.,]/g, '') }))} required />
                                </div>
                                <div className="form-group">
